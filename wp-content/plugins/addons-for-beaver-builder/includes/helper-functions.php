...
function labb_get_chosen_terms( $query_args )
{
    ...
    return apply_filters( 'labb_chosen_taxonomy_terms', $return, $query_args );
}
...
function labb_get_taxonomy_terms_filter( $taxonomies, $chosen_terms = array() )
{
    $output = '';
    $terms = array();
...
function labb_get_template_part( $template_name, $settings )
{
